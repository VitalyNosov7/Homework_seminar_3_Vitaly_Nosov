Получено задание из ветки content_draft (черновик). Необходимо зафиксировать состояние ветки content_formatting (форматирование контента) перед слитием ветки content_draft (черновик).
